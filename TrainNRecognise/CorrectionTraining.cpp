...
int correctionTraining() {
	...
	cv::FileStorage fsClassificationsRead(classPath + "\\classifications.xml", cv::FileStorage::READ);        

	if (fsClassificationsRead.isOpened() == false) {
		std::cout << "error, unable to open training classifications file, exiting program\n\n";
		return(false);
	}

	fsClassificationsRead["classifications"] >> matClassificationInts;
	fsClassificationsRead.release();
...
// read in training images ////////////////////////////////////////////////////////////
	...
	imgTrainingNumbers = cv::imread(getImgPath());          // read in training numbers image
